...
const userOwnedTables = new Set([
  ...
  'quick_replies', 'automations', 'automation_logs',
  'automation_pending_executions', 'flows', 'flow_runs', 'clinic_services',
  'clinic_rooms', 'clinic_products', 'clinic_appointments',
  'clinic_time_blocks', 'clinic_agenda_events', 'work_sessions', 'work_breaks',
  'member_presence', 'notifications', 'push_subscriptions',
  'scheduled_whatsapp_messages', 'crm_tasks', 'message_library_items',
  'contact_segments', 'marketing_automation_rules',
]);
