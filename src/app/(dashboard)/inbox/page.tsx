...
import { AlertTriangle, Loader2, Trash2, Wifi, WifiOff, X } from 'lucide-react';
...
export default function InboxPage() {
  ...
  return (
    <div className="-m-4 flex h-[calc(100vh-3.5rem)] flex-col overflow-hidden sm:-m-6">
      ...
      {isOwner ? (
        <div className="border-border bg-background flex shrink-0 items-center justify-end border-b px-4 py-2">
          <Button
            type="button"
            variant="outline"
            size="sm"
            onClick={() => setClearInboxOpen(true)}
            disabled={clearingInbox || conversations.length === 0}
